...
import fulfillAPIRequest from 'react-storefront/props/fulfillAPIRequest'; // import getBase64ForImage from 'react-storefront/utils/getBase64ForImage'
...
export default async function product({
  ...
  const raw = await client.getProduct(id, {
    allImages: true
  });
